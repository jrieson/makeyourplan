...
/*Codigo para propagar las sesiones por el resto de páginas -- si que funcionaba*/
    ...
    if(isset($_POST['actv_viajes'])){   
        
        $tipoActividad = $_POST['viajes'];
        ...
        if($sentencia -> rowCount() > 0){   
            ...
            <?php
             ...
             ?>
            <h3>Aún no hay ningún plan publicado en esta categoría. ¿Por qué no te <a href="registro.php">registras</a> y publicas tu primer plan?</h3>
            <?php
        }
...
<?php 
    ...
    if(isset($_POST['usuarioApuntado'])){
        ...
        $idActividad = htmlentities($_POST['idActividad']);  
