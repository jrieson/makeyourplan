...
/*Codigo para propagar las sesiones por el resto de páginas -- si que funcionaba*/
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <div class="carousel-caption d-block">
                                        <h2>¿Eres todo un Master Chef? ¿Quieres aprender a hacer sushi?¿Qué tal un guiso?</h2>
                                    ...
                                    <img src="../imagenes/banner_cocina.jpg">
                                </div>                            
                            </div>
                        </div>                    
                    </div>
    ...
    if(isset($_POST['actv_deportes'])){   
        
        $tipoActividad = $_POST['deportes'];
    ...
    if(isset($_POST['busquedaProvincia'])){           
        ...
        /*Extraemos de la tabla actividades los planes creados por otros Makers*/
        $sql = 'SELECT * FROM `actividades` WHERE ciudad="'.$provincia.'" AND tipo_actividad="cocina"';
